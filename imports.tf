# Auto-generated fallback imports by MigrateOps.
...
import {
  to = azurerm_container_registry.spiritops_registry
...
import {
  to = azurerm_app_managed_environment.spiritops_env
...
import {
  to = azurerm_app_managed_certificate.spiritops_certificate
...
import {
  to = azurerm_dns_zone.spiritops_dns_zone
